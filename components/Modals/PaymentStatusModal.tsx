...
const PaymentStatusModal: React.FC<PrescriptionModalProps> = ({
  isOpen,
  onClose,
  patient,
  prescription,
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await axios.put(`https://api2.caregiverhospital.com/prescription/update-payment-status/${prescription.id}/`, {
        payment_status: true,
      })
