...
const LabPaymentModal: React.FC<ModalProps> = ({ results, onClose }) => {
        ...
        <div className="px-6 py-6">
          ...
          <div className="mt-4 flex w-full gap-6">
            {results.payment_status ? (
              <p className="w-full rounded-md bg-black py-2 text-center text-2xl font-bold text-[#46FFA6]">
                Payment Recieved
              </p>
            ) : (
              <p className="h-[50px] w-full rounded-sm bg-[#F2B8B5] py-2 text-center text-black">
