...
const CustomDropdownTest: React.FC<CustomDropdownProps> = ({ options, selectedOption, onChange, placeholder }) => {
  ...
  return (
    <div className={styles.dropdown} ref={dropdownRef}>
      <div className={styles.dropdownToggle} onClick={handleToggle}>
        <span>{selectedOption ? options.find((option) => option.id === selectedOption)?.title : placeholder}</span>
        <MdKeyboardArrowDown />
      </div>
      {isOpen && (
...
export default CustomDropdownTest
