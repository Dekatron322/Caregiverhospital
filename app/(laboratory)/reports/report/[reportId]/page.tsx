...
export default function ReportDetailPage({ params }: { params: { reportId: any } }) {
  ...
  const results = LabTestResults.find((report) => report.id === reportId)
